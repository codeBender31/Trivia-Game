...
**Name of your app** is an app that allows users to play a trivia game. The questions are obtained from the Open Trivia Database.
...
![Alt text]](https://github.com/codeBender31/Trivia-Game/blob/main/Trivia_Game.gif) .

## Notes

Describe any challenges encountered while building the app.
Had a big learning curve learning how to connect to the API and output the JSON format in text form

## License

    Copyright [3/27/2024] [Abel]
